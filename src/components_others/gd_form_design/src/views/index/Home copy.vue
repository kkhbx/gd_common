  ...
  <div class="container">
    ...
    <div class="center-board">
      ...
      <el-scrollbar class="center-scrollbar">
            ...
            <draggable class="drawing-board" :list="drawingList" :animation="340" group="componentsGroup">
              <template v-for="(item, index) in drawingList">
                <div :key="index">
                  ...
                  ></draggable-item>
                  <RowFormTable v-else :form-table-list="formTableList"> </RowFormTable>
                </div>
              </template>
            </draggable>
        ...
        <!-- <RowTest :data-js="vueTemplateObj.js" :data-html="vueTemplateObj.html"></RowTest> -->
...
export default {
  ...
  methods: {
    ...
    generateCode() {
      ...
      // const aa = makeUpHtml(this.formData, type)
      // const bb = makeUpJs(this.formData, type)
      // const cc = makeUpCss(this.formData, type)
      ...
      this.vueTemplateObj.js = eval(`(${makeUpJs(this.formData, type)})`)
      this.vueTemplateObj.html = makeUpHtml(this.formData, type)
      console.log(this.vueTemplateObj.js, 'this.vueTemplateObj.js')
      localStorage.setItem('templateHtml', makeUpHtml(this.formData, type))
      localStorage.setItem('templateCss', css)
      localStorage.setItem('templateJs', makeUpJs(this.formData, type))
