      ...
      <div style="height:100%">
        <el-row style="height:100%;overflow:auto">
          ...
          <el-col :md="24" :lg="12" class="right-preview">
            ...
            <!-- <iframe v-show="true" ref="previewPage" class="result-wrapper" frameborder="0" src="/static/preview.html" @load="iframeLoad" />
...
export default {
  components: { ResourceDialog, RowTest },
  ...
  methods: {
    ...
    onOpen() {
      ...
      this.jsCode = makeUpJs(this.formData, type, true)
    ...
    setEditorValue(id, type, codeStr) {
      ...
      this.vueTemplateObj = {
        html: this.htmlCode,
        css: this.cssCode,
        js: eval(`(${this.jsCode.replace(exportDefault, '')})`)
      }
      // ctrl + s 刷新
